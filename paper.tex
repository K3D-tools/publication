...
\hline
C2 & Permanent link to code/repository used for this code version & $https://github.com/K3D-tools/K3D-jupyter$ \\
\hline
...
C6 & Compilation requirements, operating environments &  python>=3.6, notebook>5.2
   ...
   vtk,nibabel & \\
\hline
C7 & If available Link to developer documentation/manual & $https://k3d-jupyter.org/$ \\
\hline
